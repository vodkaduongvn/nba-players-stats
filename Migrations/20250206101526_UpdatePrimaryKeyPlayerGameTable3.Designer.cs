...
namespace NBA.Players.Charts.Migrations
{
    ...
    [Migration("20250206101526_UpdatePrimaryKeyPlayerGameTable3")]
    partial class UpdatePrimaryKeyPlayerGameTable3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayerGame", b =>
                {
                    b.HasOne("NBA.Players.Charts.PlayerDbContext.Entities.Game", null)
                        .WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NBA.Players.Charts.PlayerDbContext.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
